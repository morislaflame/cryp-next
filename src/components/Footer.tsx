        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href={MAIN_ROUTE} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">
                  Обмен валют
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href={RULES_ROUTE} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">
                  О нас
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={AML_ROUTE} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">
                  Безопасность
                </Link>
              </li>
            </ul>
