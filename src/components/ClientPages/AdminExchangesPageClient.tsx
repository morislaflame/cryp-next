...
const AdminExchangesPageClient: React.FC = observer(() => {
                                ...
                                {exchange.exchanges.map((exchangeItem) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-sm text-white/70 mb-1">
                                            {formatAmount(exchangeItem.from.amount, exchangeItem.from.currency)} → {formatAmount(exchangeItem.to.amount, exchangeItem.to.currency)}
                                        </div>
                    ...
                    <div className="flex-1 bg-white/5 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm ios-scroll hide-scrollbar overflow-y-auto">
                        {selectedExchange ? (
                            <div className="p-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-white/5 rounded-lg p-4">
                                            ...
                                            <div className="text-2xl font-bold text-emerald-400 mb-2">
                                                {formatAmount(selectedExchange.from.amount, selectedExchange.from.currency)}
                                            </div>
                                        ...
                                        <div className="bg-white/5 rounded-lg p-4">
                                            ...
                                            <div className="text-2xl font-bold text-blue-400 mb-2">
                                                {formatAmount(selectedExchange.to.amount, selectedExchange.to.currency)}
                                            </div>
                                ...
                                {/* Реквизиты */}
                                {(selectedExchange.recipientAddress || selectedExchange.recipientCard) && (
                                    <div className="mb-6">
