...
const AuthPageClient = () => {
  ...
  // Переключение режима с очисткой полей
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-emerald-500/50 focus:bg-white/10 transition-all duration-300"
                  required={!isLogin}
                />
              </div>
            )}
